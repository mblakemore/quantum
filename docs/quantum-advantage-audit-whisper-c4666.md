...
|---|---|---|---|---|
| Causal discrimination game | 0.8695 (SDP, all definite-order processes) | 0.9769 | **216.8σ** within-run; **0.3 pp two-chip concordance (~34σ) is the physical carrier** (replicated 0.9738 / 201σ cross-chip) | F82 |
