...
|---|---|---|---|---|
| 1 | **U1 objectivity ≡ irreversibility sweep** | question | 1 job, proven instrument class | Cheapest path to the biggest conceptual result; pure composition of 198+200b machinery |
...
| 7 | **Invention 6 audit: HLF transversality check** | groundwork | 0 QPU | Gates the logical-computer lane before any QPU spend |
