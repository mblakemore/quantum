...
| 6 | **Invention 3: shielded sensor** — ✅ **DELIVERED (Exp205 THE BLIND ANTENNA, C4902): CERTIFIED, all 4 gates.** The shield's 199 blind spot IS the antenna — 2× super-resolution, 199's acceptance curve re-read as the sensor aperture, postselection sharpens the fringe 4.47× at 32σ with Fisher/accepted = 10.3 (≥4× bare at 18σ). Honest boundary: on a good window a bare GHZ still wins raw throughput; the shield's edge is sensitivity-per-depth + self-diagnosis. See [`exp205-STATUS-certified.md`](../experiments/exp205-STATUS-certified.md) | invention | 1–2 jobs | Task-dependence of the shield's payoff (F109 lesson) on a new scoreboard |
...
| 8 | **U8 Eagle exam** — ⚠️ **cross-generation HARDWARE-BLOCKED (C4904): no Eagle device on the open plan** (boundaries.md C4904). ADAPTED → Exp207 cross-DEVICE portability of the logical computer: **CERTIFIED on ibm_marrakesh** — logical-beats-bare reproduces (logical P 0.974→0.983, Δ0.009; margin +0.048 at 14.9σ), device-independent within Heron. Eagle-ready bench frozen. See [`exp207-STATUS-certified-crossdevice.md`](../experiments/exp207-STATUS-certified-crossdevice.md) | question | 1 flight, foreign device | The standing out-of-distribution test of every law we have |
