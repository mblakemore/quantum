...
### ⭐ Indefinite causal order — the quantum switch on real silicon (F73–F77, F80, F82–F83, F85–F86, F88–F89)
...
### Communication primitives — first fill of the comms white space (F87, F90)
...
Next in the comms sequence: E2 swap-vs-teleport crossover **executed → F90** (Exp110, the informative null landed). E1, the ICO-vs-coherent-control resource comparison, **executed and won** — see **F89** in the causal-order arc above (Exp111: switch strictly exceeds paths at ~20σ, ratio 1.949 vs theory 2.00). Remaining paths per the comms doc: E5 semi-DI randomness (scoped + PARKED, gap named).
