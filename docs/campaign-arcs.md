...
Next in the comms sequence: E2 swap-vs-teleport crossover (Exp110 designed). E1, the ICO-vs-coherent-control resource comparison, has been **executed and won** — see **F89** in the causal-order arc above (Exp111: switch strictly exceeds paths at ~20σ, ratio 1.949 vs theory 2.00).
