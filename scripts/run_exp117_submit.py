#!/usr/bin/env python3
"""run_exp117_submit.py — Exp117 extraction stroke (Whisper C4614).
Prereg: experiments/exp117-extraction-stroke-preregistration.md (FROZEN).
...
def main():
    ...
    ap.add_argument("--tag", default="exp117")
    args = ap.parse_args()
    ...
    jid = job.job_id()
    manifest = {
        "experiment": "exp117-extraction-stroke", "cycle": "C4614-whisper",
        "backend": args.backend, "tag": args.tag,
        "prereg": "experiments/exp117-extraction-stroke-preregistration.md",
