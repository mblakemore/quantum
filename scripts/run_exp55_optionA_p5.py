...
P = 5                            # Option A re-scope (C4128): p=5 is where the Exp53 traps live
SHOTS = 1024
MAX_ITER = 50
...
CHECKPOINT_PATH = os.path.join(RESULTS_DIR, "exp55_optionA_p5_checkpoint.json")
RESULTS_PATH = os.path.join(RESULTS_DIR, "exp55_optionA_p5_results.json")
...
def main():
    print("=" * 64, flush=True)
    print("EXP55 Option A (p=5): Noise-Assisted Escape re-scope (Whisper C4148, Elder C5899 substrate note)", flush=True)
