...
Ordering is row-major and EXPLICIT (per-parameter-row loop, 316 shots each) so
the grader's row_map positions (0..111) line up with the sealed/cal interleave.
Refuses to bank unless the job is DONE and the shape is exactly 112*316.
"""
import sys, os, re, json, hashlib, datetime

JOB_ID = "da11onkdedkc73eqge2g"
BACKEND = "ibm_marrakesh"
EXPERIMENT = "doora_deg2phase_v1_flight4"
COMMITMENT = "c31a1c861a840318c1baaa07bbb802d4f18876f3dd56b5c8c0a9016b73a6cdaa"
N = 8
PUB_ROWS = 112          # 80 sealed + 32 cal
SHOTS = 316
EXPECT_STRINGS = PUB_ROWS * SHOTS          # 35,392
...
OUT = f"results/doora_flight4_raw_{JOB_ID}.json"
...
def main():
    ...
    # EXPLICIT row-major: row 0's 316 shots, then row 1's, ... row 111's.
    strings = []
