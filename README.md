...
| **Cross-VENDOR certification** — the causal axis on a **non-IBM** chip, same frozen theory bounds, no retuning (indefinite causal order is not a Heron artifact) | **PASS-CAUSAL** — W 1.114 (49.7σ over 0), capacity 0.271 (19.5σ over 0.10), null clean; ranks ≪ Heron (W 1.11 vs 1.90) | `Rigetti Cepheus-1-108Q` (Amazon Braket), [Exp210](experiments/braket-exp210-rigetti-cross-platform-causal-RESULTS.md) |
