...
| **N=3 cyclic switch** — capacity scaling (+70% target), first load-bearing sentinel-gated window harvest at lottery-zone depth | in flight | [pre-reg](experiments/exp107-cyclic3-capacity-preregistration.md) · [audit](experiments/three-switch-audit-verdict-whisper-c4531.md) |
