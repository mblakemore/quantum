...
|---|---|---|---|---|---|---|---|---|---|
| repeat1 | 20 | 12 (HELD) | 0.1708 | 0.1153 | **0.6749 ± 0.0503** | [0.576, 0.773] | **below** | **WALL (r < 0.8) at the per-rung rule** | 0.1282 (floor 0.128, margin 0.0002) · 4 before the accepted attempt (0.0183, 0.0699, 0.0960 → 0.1282) |
