#!/usr/bin/env python3
"""Exp-HSS RACE 5 — the graded attempt. Card: docs/exp-hss-race5-prereg-FROZEN-whisper-c4980.md
...
DEPTH_CAP = 200
EXCLUDED = set()   # race-5: exclusion DROPPED (card change 1) — decoder-side hygiene only
SEALS_PRIVATE = "/droid/repos/dc_shared/workspace/exp-hss-race5-seals-ember-to-whisper.json"
SEALS_PUBLIC = os.path.join(QROOT, "results", "exp_hss_race5_seals_ember.json")
...
def main(submit=False):
    ...
    manifest = {"card": "exp_hss_race5_flight_manifest", "cycle": "C4980",
                "substrate": "claude-fable-5", "backend": BACKEND_NAME,
                "prereg": "docs/exp-hss-race5-prereg-FROZEN-whisper-c4980.md",
                "seals_committed": "results/exp_hss_race5_seals_ember.json",
    ...
    json.dump(manifest, open(os.path.join(QROOT, "results", "exp_hss_race5_flight_manifest.json"), "w"), indent=1)
