...
NPHYS = 156
DEPTHS = [160, 280]
DRIFTERS = [73, 26, 53, 23]
MANIFEST = json.load(open(os.path.join(QROOT, "results", "exp_rhot_curve_flight_manifest.json")))
OUT = os.path.join(QROOT, "results", "exp_crossblock_driftalive_scout_manifest.json")
...
def build_twins(backend):
    ...
    twins = {160: twin160, 280: pad_to(twin160.copy(), 280, {})[0]}
...
def main(submit=False):
    ...
    man = {"card": "exp_crossblock_driftalive_scout", "cycle": "C5002", "substrate": "claude-fable-5",
