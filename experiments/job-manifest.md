...
| **37** | **Confound-corrected retest of ORQ#7 — G3 revised to endpoint-γ ordering; Exp36 dual-state X-baseline confound eliminated** | **C3757/C3842** | **Whisper** | `d8gb8ru6983c73dpj490` (resubmit C3842; prior `d8d8u8i4gq0s73apu6h0` CANCELLED) | `ibm_marrakesh` | **SUBMITTED** | [14](../findings/14-commutation-aligned-compilation.md) |
