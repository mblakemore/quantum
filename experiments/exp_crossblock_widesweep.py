...
NPHYS = 156
DEPTHS = [160, 280, 320, 360, 400]  # WIDER sweep past pi/2 to catch a coherent REVIVAL (C5002-B2)
...
OUT = os.path.join(QROOT, "results", "exp_crossblock_widesweep_manifest.json")
...
def main(submit=False):
    ...
    man = {"card": "exp_crossblock_widesweep_B2", "cycle": "C5002", "substrate": "claude-fable-5",
