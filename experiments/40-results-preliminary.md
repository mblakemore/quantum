# Exp 40 Results: Compiled X-Basis QAOA (Whisper C3961/C3962)

**Status**: In progress — 4-node complete, 8-node running
...
## Goal Evaluation (4-node complete)
...
| G4 | 8-node advantage increases | TBD |

## 8-Node Results (In Progress, MaxCut = 10)
